...
<head>
    ...
    <title>Admincast bootstrap 4 &amp; angular 5 admin template, Шаблон админки | Calendar</title>
        ...
        <nav class="page-sidebar" id="sidebar">
            <div id="sidebar-collapse">
                ...
                <ul class="side-menu metismenu">
                    ...
                    <li>
                        <a class="active" href="calendar.html"><i class="sidebar-item-icon fa fa-calendar"></i>
