...
<head>
    ...
    <title>Admincast bootstrap 4 &amp; angular 5 admin template, Шаблон админки | Sparkline Charts</title>
                ...
                <ul class="side-menu metismenu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav-2-level collapse in">
                            ...
                            <li>
                                <a class="active" href="charts_sparkline.html">Sparkline Charts</a>
                            </li>
                        </ul>
                    </li>
                    <li>
